        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/flormery/2025pruebas.git'
                }
            }
        }
        stage('Build') {
